...
export default function ProjetRobotiqueDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={projet.nom}
        description="Détails du projet robotique"
        breadcrumbs={[
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Link href={`/services/robotique/${projet.id}/edit`}>
          <Button variant="outline">
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  >
                    <Bot className="h-8 w-8" style={{ color: themeColor }} />
                  </div>
                  <div>
